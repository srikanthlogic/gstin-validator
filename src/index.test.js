...
describe('gstin-validator', function () {
	...
	it('Should return false if 15 digit non regex matching GSTIN is validated', function () {
	...
	it('Should return true if valid 15 digit GSTIN is passed', function () {
		var result = validator.isValidGSTNumber('27AAGCG4576J1Z6'); //Google India
		expect(result).to.be.true;
	});
	
	it('Should return true for GSTIN of Indian Oil across all states', function() {
